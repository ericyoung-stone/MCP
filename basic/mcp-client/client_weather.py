...
class MCPClient:
    ...
    async def process_query(self, query: str) -> str:
        ...
        response = await self.session.list_tools()  # 向 MCP 服务器请求所有已注册的工具（用 @mcp.tool() 标记）。
        """
        ...
        print(f"available_tools: {convert_pretty_json(available_tools)}")
